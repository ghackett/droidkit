...
//        BoundLazyLoader.shutdownInstance();
	...
	public static boolean doesDeviceHaveACamera() {
		return sApplicationContext.getPackageManager().hasSystemFeature(PackageManager.FEATURE_CAMERA)
				|| sApplicationContext.getPackageManager().hasSystemFeature(PackageManager.FEATURE_CAMERA_FRONT);
	}
...
//		}
	...
	public static void toastScreenBucket() {
		...
		if (density == DisplayMetrics.DENSITY_HIGH) {
			...
			Toast.makeText(sApplicationContext, "Density is neither XHIGH, HIGH, MEDIUM OR LOW.  Density is " + String.valueOf(density), Toast.LENGTH_LONG)
					.show();
		}
